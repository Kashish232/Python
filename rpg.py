...
# Randomly makes a section of the password from the specified character set
...
if (special_error):
    print("Error! Invalid Special chracter requirement!")
...
if ((not length_error) and (not capital_error) and (not num_error) and (not special_error)):
    ...
    make_password(special_req, special_char) # Makes special characters
